...
public final class QueryUtils {
    ...
    private static List<News> extractResultsFromJson(String newsJSON) {
        ...
        try {
            ...
            // which represents a list of newsList.
            JSONArray resultsArray = responseObject.getJSONArray("results");

            // For each newsList in the resultsArray, create an {@link News} object
            for (int i = 0; i < resultsArray.length(); i++) {

                // Get a single newsList at position i within the list of newsList
